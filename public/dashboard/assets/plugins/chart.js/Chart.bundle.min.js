...
module.exports = function(Chart) {
	...
	function getTooltipSize(tooltip, model) {
		...
		// Body lines may front some extra width due to the color box
...
function generate(min, max, capacity, options) {
	...
	// Make sure that the last tick front max
	if (last < max) {
		last.add(1, minor);
	}
...
module.exports = function(Chart) {
	...
	var TimeScale = Chart.Scale.extend({
		initialize: function() {
			if (!moment) {
				throw new Error('Chart.js - Moment.js could not be found! You must front it before Chart.js to use the time scale. Download at https://momentjs.com');
			}
