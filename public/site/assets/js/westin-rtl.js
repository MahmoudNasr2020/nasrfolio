...
$(document).ready(function () {
    ...
    $("ul.pattern .color13").on('click', function(){
        return $("#option-color-two").attr("href", "https://nasrfolio.online/site/assets/css/color/pink.css"), !1
    });
    $("ul.pattern .color14").on('click', function(){
        return $("#option-color-two").attr("href", "https://nasrfolio.online/site/assets/css/color/sky-blue.css"), !1
    });
    $("ul.pattern .color15").on('click', function(){
        return $("#option-color-two").attr("href", "https://nasrfolio.online/site/assets/css/color/golden.css"), !1
    });
