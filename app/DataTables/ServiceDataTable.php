    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action',function($data){
                return ' <a href="">
                                <i title="تعديل"
                                class="fa fa-pen edit"  data-route="'.route('dashboard.service.edit',['id'=>$data->id]).'"
                                ...
                                data-id="'.$data->id.'" data-route="'.route('dashboard.service.delete',['id'=>$data->id]).'"
            ...
            ->rawColumns(['image','status','action','created_At','updated_At','multi_delete']);
    }
