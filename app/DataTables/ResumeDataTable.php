    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action',function($data){
                return ' <a href="">
                                <i title="تعديل"
                                class="fa fa-pen edit"  data-route="'.route('dashboard.resume.edit',['id'=>$data->id]).'"
                                ...
                                data-id="'.$data->id.'" data-route="'.route('dashboard.resume.delete',['id'=>$data->id]).'"
            ...
            ->rawColumns(['status','action','created_At','updated_At','multi_delete']);
    }


    public function query(Resume $model)
    {
        return Resume::query()->with('category')->select('resumes.*');
    }
