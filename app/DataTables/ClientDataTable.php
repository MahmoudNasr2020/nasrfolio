    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action',function($data){
                return ' <a href="">
                                <i title="تعديل"
                                class="fa fa-pen edit"  data-route="'.route('dashboard.client.edit',['id'=>$data->id]).'"
                                ...
                                data-id="'.$data->id.'" data-route="'.route('dashboard.client.delete',['id'=>$data->id]).'"
