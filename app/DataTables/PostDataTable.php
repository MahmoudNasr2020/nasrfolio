    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action',function($data){
                return '<a href="'.route('dashboard.post.show',['id'=>$data->id,'title'=>str_replace(' ' ,'_',$data->title)]).'">
                                <i title="عرض" class="fa fa-eye ml-2" style="cursor: pointer;color:blue;font-size:20px"></i>
                                </a>
                                <a href="'.route('dashboard.post.edit',['id'=>$data->id,'title'=>str_replace(' ' ,'_',$data->title)]).'">
                                <i title="تعديل" class="fa fa-pen ml-2" style="cursor: pointer;color:green;font-size:20px"></i>
                                </a>
                                <i data-bs-toggle="tooltip" data-bs-placement="bottom" title="حذف" class="fa fa-trash delete"
                                data-id="'.$data->id.'" data-route="'.route('dashboard.post.delete',['id'=>$data->id]).'"
