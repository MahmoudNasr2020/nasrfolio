category
    ...
    @include('dashboard.pages.posts.container.include.ajax.delete')
    @include('dashboard.pages.posts.container.include.ajax.multi_delete')
    @include('dashboard.pages.posts.container.include.ajax.status')
