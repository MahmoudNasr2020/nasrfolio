category
    ...
    @include('dashboard.pages.interview.container.include.ajax.add')
    @include('dashboard.pages.interview.container.include.ajax.edit')
    @include('dashboard.pages.interview.container.include.ajax.delete')
    @include('dashboard.pages.interview.container.include.ajax.multi_delete')
