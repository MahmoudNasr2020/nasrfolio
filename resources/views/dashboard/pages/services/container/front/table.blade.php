...
@include('dashboard.pages.services.container.front.modals.add')
@include('dashboard.pages.services.container.front.modals.edit')
@include('dashboard.pages.services.container.front.modals.image')
