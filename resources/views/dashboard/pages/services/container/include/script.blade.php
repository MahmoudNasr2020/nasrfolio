category
    ...
    @include('dashboard.pages.services.container.include.ajax.add')
    @include('dashboard.pages.services.container.include.ajax.edit')
    @include('dashboard.pages.services.container.include.ajax.delete')
    @include('dashboard.pages.services.container.include.ajax.multi_delete')
    @include('dashboard.pages.services.container.include.ajax.status')
