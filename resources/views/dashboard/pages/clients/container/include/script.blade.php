category
    ...
    @include('dashboard.pages.clients.container.include.ajax.add')
    @include('dashboard.pages.clients.container.include.ajax.edit')
    @include('dashboard.pages.clients.container.include.ajax.delete')
    @include('dashboard.pages.clients.container.include.ajax.multi_delete')
    @include('dashboard.pages.clients.container.include.ajax.status')
