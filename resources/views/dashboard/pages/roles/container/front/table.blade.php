    ...
    <div class="col-xl-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('dashboard.role.create') }}"  style="display:inline-block">
                    <button class="btn btn-success btn-icon mb-2" title="اضافة ],c"><i class="typcn typcn-document-add"></i></button>
                </a>
