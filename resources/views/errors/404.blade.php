<html>
    <head>
        <title>{{ settings()->site_name }} | الصفحة غير موجودة</title>
    ...
    <body dir="rtl" style="overflow: hidden;font-family: 'Noto Kufi Arabic', sans-serif !important;">
        <div id="wrap">
            <div id="wordsearch">
                <ul>
                    <li>k</li>
            ...
            <div id="main-content">
                ...
                <p>نعتقد انك قمت بالدخول الي الصفحة الخطأ.</p>

                <p>الرجوع الي الصفحة الرئيسية.</p>


                <div id="navigation">
                    <a class="navigation" href="{{ \Illuminate\Support\Facades\URL::to('/') }}" style="float: right">الرئيسية</a>
                </div>
            </div>
        </div>
