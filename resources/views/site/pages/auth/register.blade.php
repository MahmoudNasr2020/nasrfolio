...
@section('header')
    <ul class="navbar-nav nav-pills ml-auto">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('site.register.index') }}">مستخدم جديد</a>
        </li>

        <li class="nav-item">
            <a class="nav-link" href="{{ route('site.login.index') }}">تسجيل الدخول</a>
        </li>
    </ul>
@stop
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="title-box text-left">
                            <h6>سجل الدخول</h6>
                            <h3 class="title-header">مستخدم جديد</h3>
                        </div>
                    </div>
                </div>
            </div>
                           ...
                           <div class="contact-01">
                               <div class="contact my-5">
                                   <div class="contact-form">
                                       <h3 class="text-left mb-4">مستخدم جديد</h3>
                                       <div class="contact-box">
                                           <div class="contact-form">
                                               <form id="contactForm" method="post" action="{{ route('site.register.register') }}">
                                                   @csrf
