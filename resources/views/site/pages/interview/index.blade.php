...
@section('header')
    <ul class="navbar-nav nav-pills ml-auto">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('site.posts') }}">اسئلة المقابلة</a>
        </li>
        @guest
            <li class="nav-item">
                <div class="dropdown">
...
@section('content')
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="title-box text-left">
                            <h6> بعض اسئلة المقابلة </h6>
                            <h3 class="title-header">اسئلة المقابلة</h3>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!--   POST Start   -->
    <section id="blog" class="blog-02 py-6 bg-grey" style="direction:ltr">
        <div class="container">
                        ...
                        @foreach($interviews as $key=>$interview)
                            <div class="card">
                                <div class="card-header p-0" id="heading{{ $key }}">
                                    <h2 class="mb-0">
                                        <button class="d-flex py-4 px-4 align-items-center justify-content-between btn btn-link" data-toggle="collapse"
                                                data-target="#collapse{{ $key }}" aria-expanded="true" aria-controls="collapse{{ $key }}">

                                            <p class="mb-0">   <img src="{{ asset('site/images/laravel.svg') }}" width="30px" style="margin-right: 19px;">{{ $interview->question }}</p>
                                    ...
                                    <div class="card-body py-5 px-4">
                                        <div class="menus d-md-flex">
                                            <div class="text">
                                                <div class="d-flex">
                                                    <div class="one-half">
                                                        <h3 style="font-family: cursive !important;">{{ $interview->en_answer }}</h3>
                                                    </div>
                                                    <div class="one-forth">
                                                        <span class="price" style="margin-right:-95px">English</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="menus d-md-flex" style="direction:rtl">
                                            <div class="text">
                                                <div class="d-flex">
                                                    <div class="one-half" style="float: right;text-align: right;">
                                                        <h3 style="font-family: cursive !important;">{{ $interview->ar_answer }}</h3>
                                                    </div>
                                                    <div class="one-forth">
                                                        <span class="price" style="position: relative;left: -154px;">Arabic</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
